...
require_repo_literal "tests/test_review_support_scripts.py" 'test_alternative_reviewer_claude_split_jsonl_preserves_tool_use'
...
require_repo_literal "tests/test_review_support_scripts.py" 'test_command_lock_respects_env_run_dir'
