...
require_repo_literal "scripts/install_to_codex.py" 'install_standalone_skill'
...
require_repo_literal "scripts/install_to_codex.py" 'Review Validate Fix CLI Launcher'
require_repo_literal "scripts/install_to_codex.py" 'Use only when the user explicitly writes `$review-validate-fix`'
...
require_repo_literal "tests/test_install_to_codex.py" 'local standalone config'
require_repo_literal "tests/test_install_to_codex.py" 'Review Validate Fix CLI Launcher'
