...
require_literal "SKILL.md" '当前可用的最佳模型'
require_literal "SKILL.md" 'reasoning_effort=high'
...
require_literal "SKILL.md" 'CODEX_RVF_FORK_MODE=auto'
require_literal "SKILL.md" 'CODEX_RVF_FORK_MODE=cline-kanban'
...
require_repo_literal "tests/test_codex_stop_review_validate_fix.py" 'test_auto_mode_uses_legacy_gui_as_backup_of_backup'
...
require_repo_literal "scripts/install_to_codex.py" 'remove_legacy_codex_skill_dir'
...
require_repo_literal "tests/test_install_to_codex.py" 'test_remove_legacy_codex_skill_dir_removes_broken_symlink'
require_repo_literal "tests/test_install_to_codex.py" 'test_main_syncs_legacy_only_setup_into_empty_plugin_cache'
require_repo_literal "tests/test_install_to_codex.py" 'test_main_syncs_legacy_config_over_default_plugin_cache'
require_repo_literal "tests/test_install_to_codex.py" 'local legacy config'
require_repo_literal "tests/test_install_to_codex.py" 'assert not legacy_skill.exists()'
