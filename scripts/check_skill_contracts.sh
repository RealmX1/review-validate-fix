...
require_literal "prompts/validate-fix.md" 'REAL'
require_literal "prompts/validate-fix.md" 'FALSE_POSITIVE'
require_literal "prompts/validate-fix.md" 'ELEVATE'
require_literal "prompts/validate-fix.md" 'elevation-detail'
