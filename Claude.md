...
This project is indexed by GitNexus as **review-validate-fix** (5325 symbols, 12624 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
