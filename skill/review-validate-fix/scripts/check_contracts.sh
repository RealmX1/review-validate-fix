...
require_literal "SKILL.md" 'Codex Stop fork hook'
...
require_literal "SKILL.md" 'CODEX_RVF_FORK_MODE=terminal'
...
require_literal "scripts/codex_stop_review_validate_fix.py" 'DEFAULT_FORK_LAUNCH_MODE = "terminal"'
...
require_literal "scripts/test_codex_stop_review_validate_fix.py" 'test_dirty_repo_launches_terminal_fork_by_default'
