...
require_literal "SKILL.md" 'continuation prompt'
...
require_literal "scripts/codex_stop_review_validate_fix.py" 'DEFAULT_RVF_MODE = "continuation"'
require_literal "scripts/codex_stop_review_validate_fix.py" 'DEFAULT_FORK_LAUNCH_MODE = "manual"'
...
require_literal "scripts/codex_stop_review_validate_fix.py" 'terminal-launch-disabled'
...
require_literal "scripts/codex_stop_review_validate_fix.py" 'codex'
require_literal "scripts/codex_stop_review_validate_fix.py" 'fork'
require_literal "scripts/codex_stop_review_validate_fix.py" 'CODEX_RVF_SUPPRESS_STOP_HOOK=1'
require_literal "scripts/test_codex_stop_review_validate_fix.py" 'test_fork_experiment_marker_dry_run'
require_literal "scripts/test_codex_stop_review_validate_fix.py" 'test_dirty_repo_continues_in_gui_by_default'
require_literal "scripts/test_codex_stop_review_validate_fix.py" 'test_dirty_repo_manual_mode_only_prepares_launcher'
